...
const AboutMe = () => {
 ...
 useEffect(() =>{
   ...
   const getData = async () => {
    ...
    return (
        <div className='md:flex md:justify-between mt-32 pl-10 pr-10 mb-32'>
            <div >
                <h1 className='lg:text-xl text-center text-gray-400 tracking-widest'>ABOUT ME</h1>
                  ...
                  <p data-aos="fade-up" data-aos-delay="100" data-aos-duration="2800" className='font-semibold  md:ml-96 mt-20 text-3xl tracking-wider '>{data.headTxt}</p>  
